    ...
    <div className="section bg-[#E58FD6] lg:h-[110vh] sm:h-[45vh]">
      ...
      <div className="w-full py-16 px-4">
        {/* <motion.img
          ...
          src={flower}
          alt=""
          className="lg:visible absolute lg:left-52 sm:left-28"
        /> */}
        <motion.p
          className="font-c font-bold text-center tracking-widest md:text-7xl sm:text-5xl"
          initial={{ opacity: 0 }}
      ...
      <div>
        <section className={`flex flex-col justify-center items-center`}>
          <div className={`flex flex-col`}>
            ...
            <div className="w-full py-16 px-4">
              <div className="bg-[#e4d0e1] bg-opacity-30">
                <h3 className="text-black font-c tracking-widest md:text-2xl sm:text-2xl text-xl text-center">
                  {currSkill}
                </h3>
              </div>
            </div>
