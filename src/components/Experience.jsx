...
const Experience = ({ name, position, logo, tenure, overview }) => {
  return (
    <div className="hover:bg-[#303030] rounded-lg lg:h-[85vh] sm:h-[60vh]">
      <section
        className={`w-full shadow-xl flex flex-col p-10 lg:h-[85vh] sm:h-[60vh] rounded-lg hover:cursor-pointer hover:scale-105 duration-300 `}
      >
        <img
          src={logo}
          alt={name}
